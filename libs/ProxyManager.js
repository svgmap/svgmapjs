class ProxyManager {
	...
	getAccessInfo(rPath) {
		var pxPath;
		if (typeof this.#contentProxyParams.getUrlViaProxy == "function") {
	...
	getImageAccessInfo(href, needsNonLinearTF, crossoriginProp) {
		...
		if (typeof this.#contentProxyParams.getUrlViaImageProxy == "function") {
			...
			typeof this.#contentProxyParams.getNonlinearTransformationProxyUrl ==
				"function" &&
			needsNonLinearTF
		) {
	...
	setProxyURLFactory(
		...
		if (
			...
			this.#contentProxyParams.getNonlinearTransformationProxyUrl =
				imageURLviaProxyFunctionForNonlinearTransformation;
