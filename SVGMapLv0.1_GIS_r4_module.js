...
// 2026/02/24 drawKML, drawGeoJSONをモジュール分け => SVGMapVectorFileRenderer.js
//
// ISSUES:
//
// --- これらはFixedとなったかな？
...
class SvgMapGIS {
	...
	constructor(svgMapObject, jstsObject) {
		...
		this.#vectorFileRenderer = new SVGMapVectorFileRenderer(this.#svgMap);
		if (this.#jsts) {
...
//			console.log("layerId:",docId , " rootLayer:",svgImagesProps[docId].rootLayer);
	...
	drawGeoJson(...params) {
		// レンダラーに処理を丸投げ 2026/02/24
		return this.#vectorFileRenderer.drawGeoJson(...params);
	}
	drawKml(...params) {
		// レンダラーに処理を丸投げ 2026/02/24
		return this.#vectorFileRenderer.drawKml(...params);
	}
